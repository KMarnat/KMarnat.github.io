...
const findMatch = async function () {
  try {
    ...
    if (!weatherData.name) {
      ...
      searchedSunrise.setHours(searchedSunrise.getHours() - 3);
      ...
      searchedSunset.setHours(searchedSunset.getHours() - 3);
...
// toggle button "More..." for extra info
function toggleAdv() {
  boxOne.classList.toggle('box-animation');
  boxThree.classList.toggle('box-animation');
}
